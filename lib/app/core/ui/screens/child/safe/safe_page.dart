      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Image.asset('assets/icons/icon_pig.png'),
              const SizedBox(
                height: 10,
              ),
              Text('Cofrinho', style: TextStyle(
                fontSize: 22,
              ...
              Padding( padding: EdgeInsets.fromLTRB(15, 0, 15, 0), child:
              ...
              Image.asset('assets/images/image_safe.png')
            ],
          ),
        ),
      ),
